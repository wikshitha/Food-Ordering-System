...
export default function PaymentCancel() {
  ...
  return (
    <div className="min-h-screen bg-primary text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* background blobs (same system UI) */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-secondary/10 border border-secondary/25 backdrop-blur-xl text-center flex flex-col gap-6 items-center animate-fade-in">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-3 leading-relaxed">
              Your payment was not processed. You can retry or return to the menu.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-action text-black font-semibold"
            >
              Retry Payment
            </button>
            ...
            <Link
              to="/"
              className="flex-1 py-3 rounded-xl bg-secondary/20 border border-secondary/30 text-white text-center"
            >
              Back to Menu
            </Link>
